...
app.post('/search', (req,res) =>{
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?query=${userMovieTitle}&api_key=db428011a9f0984740b0d7c5974d2962`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=db428011a9f0984740b0d7c5974d2962&language=en-US';
